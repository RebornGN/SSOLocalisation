...
ini_set('max_execution_time', 300000);
	...
	// SAVE FILE
	function generate_file($lang,$name_correctly)
	{
		$correct_names=array('en'=>'lang_en-US','es'=>'lang_es-AR','pt'=>'lang_pt-BR','fr'=>'lang_fr-FR','th'=>'lang_th-TH','pl'=>'lang_pl-PL');
	...
	if($lang == 'all'){
		$all=array('en','es','pt','fr','pl','th');
		$cnt =count($all);
		for($i=0;$i<$cnt;$i++) generate_file($all[$i],true);
	}
	else generate_file($lang,false);
